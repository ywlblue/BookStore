    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                ...
                <form action="update_customer" method="post" id="newForm" name="newForm">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="email" name="email" size="50" type="email" value="${customer.email}" required>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input class="pwd" name="password" id="pwd" size="50" type="password" value="${customer.password}" required></input></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>Confirm Password：</th>
                                <td><input class="pwd" name="confirm_password" id="confirm_pwd" size="50" type="password" value="${customer.password}" required></input></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input class="common-text" name="zip_code" size="50" type="text" value="${customer.zipcode}" required></td>
                            </tr>
                            <tr>
