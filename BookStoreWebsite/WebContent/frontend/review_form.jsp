         ...
         <hr />
            <div class="signup-content">
                ...
                <div class="write-review-form">
                    ...
                    <form method="post" class="review-form" id="review-form" action="submit_review">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="comment" class="common-textarea" id="comment"></textarea>
                        </div>
                        <div class="form-submit">
                        	<input type="submit" value="Cancel" class="submit" name="cancel" id="cancel" Save" type="submit"
										onClick="history.go(-1)" />
                            <input type="submit" value="Submit Review" class="submit" name="submit" id="submit" />
                        </div>
